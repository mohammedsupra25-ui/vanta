...
import {
  ...
  StopShowdown,
  AICommunication
} from '../components/interactives/VantaInteractiveV2'
  ...
  types: {
    ...
    interactive: ({ value }: any) => {
      switch (value.type) {
        ...
        case 'v2-AnalysisFlow': return <AnalysisFlow />
        case 'v2-ShapeExplainer': return <ShapeExplainer />
        case 'v2-MutationExplainer': return <MutationExplainer />
        case 'v2-ComplexCorrections': return <ComplexCorrections />
        case 'v2-ConfirmationExplainer': return <ConfirmationExplainer />
        case 'v2-ZeroBTrendline': return <ZeroBTrendline />
        case 'v2-ExtensionTypes': return <ExtensionTypes />
        case 'v2-EntryTypes': return <EntryTypes />
        case 'v2-DegreeTest': return <DegreeTest />
        case 'v2-DontGetTrapped': return <DontGetTrapped />
        case 'v2-ProtocolWalkthrough': return <ProtocolWalkthrough />
        case 'v2-StopShowdown': return <StopShowdown />
        case 'v2-AICommunication': return <AICommunication />
